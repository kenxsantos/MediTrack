...
public class CartBuyMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton = findViewById(R.id.btnCartBuyMedBookDate);
        btnCheckOut = findViewById(R.id.btnCartBuyMedCheckOut);
        btnBack = findViewById(R.id.btnCartBuyMedBack);
        tvTotal = findViewById(R.id.cartBuyMedTotalCost);
        lst = findViewById(R.id.cartBuyMedListView);
        ...
        btnCheckOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int listView = lst.getAdapter().getCount();
                if (listView == 0){
                    Toast.makeText(getApplicationContext(), "You do not have any item in cart", Toast.LENGTH_SHORT).show();
                }else{
